...
Provides a clean public API for PPT generation with safe execution.
"""
...
def build_pptx(
    ...
    Wraps the builder service with safe execution to prevent crashes.
    Auto-generates the output path if not provided.
