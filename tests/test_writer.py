...
def test_writer_agent_error_handling(mock_agent_state):
    ...
    with patch('agentic_ppt_builder.agents.writer_agent.ChatGroq') as MockLLM:
        ...
        with patch('agentic_ppt_builder.agents.writer_agent.JsonOutputParser') as MockParser:
